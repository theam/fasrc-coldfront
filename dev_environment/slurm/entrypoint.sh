...
then
    ...
    if [[ $accts -eq 3 ]]; then
        ...
        # User 'enovakova' with default account 'mustermann_lab'
        sacctmgr -i add user enovakova DefaultAccount=mustermann_lab fairshare=3
        ...
        # User 'jjonsson' with default account 'sidorov_lab'
        sacctmgr -i add user jjonsson DefaultAccount=sidorov_lab fairshare=3
        ...
        # User wdebruijn with default account 'yamada_lab'
        sacctmgr -i add user wdebruijn DefaultAccount=yamada_lab fairshare=3
        # User 'ycohen' with default account 'yamada_lab'
        sacctmgr -i add user ycohen DefaultAccount=yamada_lab fairshare=3
